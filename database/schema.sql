...
INSERT INTO members (first_name, last_name, location, program_of_study, contact_number, email, date_of_birth) VALUES
('John', 'Doe', 'Downtown', 'Computer Science', '+1234567890', 'john.doe@email.com', '1990-05-15'),
('Jane', 'Smith', 'Uptown', 'Business Administration', '+1234567891', 'jane.smith@email.com', '1985-08-22'),
('Mike', 'Johnson', 'Westside', 'Engineering', '+1234567892', 'mike.johnson@email.com', '1992-12-10'),
('Sarah', 'Williams', 'Eastside', 'Medicine', '+1234567893', 'sarah.williams@email.com', '1988-03-28'),
('David', 'Brown', 'Downtown', 'Law', '+1234567894', 'david.brown@email.com', '1995-07-14');
